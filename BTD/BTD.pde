...
void setup(){
  ...
  // 1 hp, 5 spd, 40 size, 10 cash, 4 move dist, 0 type
  // 2 hp, 4 spd, 40 size, 20 cash, 4 move dist, 1 type
  // 3 hp, 3 spd, 40 size, 30 cash, 4 move dist, 2 type
  // 4 hp, 2 spd, 40 size, 40 cash, 3 move dist, 3 type
  // 5 hp, 1 spd, 40 size, 50 cash, 2 move dist, 4 type
  // 6 hp, 1 spd, 40 size, 60 cash, 3 move dist, 5 type
